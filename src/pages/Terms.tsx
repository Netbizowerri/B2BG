...
export default function Terms() {
  return (
    <>
      <SeoMeta
        title="Terms and Conditions | Blessed2Bless Global Empowerment Organisation (B2BG)"
        description="Review the terms and conditions governing use of the B2BG website, services, and donation pledge interactions."
        path="/terms"
      />
      <div className="pt-20">
