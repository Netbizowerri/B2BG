...
export default function PrivacyPolicy() {
  return (
    <>
      <SeoMeta
        title="Privacy Policy | Blessed2Bless Global Empowerment Organisation (B2BG)"
        description="Read the B2BG privacy policy to understand how we collect, use, and protect personal information shared through our platform."
        path="/privacy-policy"
      />
      <div className="pt-20">
